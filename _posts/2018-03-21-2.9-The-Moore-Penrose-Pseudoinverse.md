...
But in the cases where the set of equations have 0 or many solutions the inverse cannot be found and the equation cannot be solved. The pseudoinverse is $\bs{B}$ such as:
...
In general there is no solution to overdetermined systems (see [2.4]() ; [Overdetermined systems](https://en.wikipedia.org/wiki/Overdetermined_system)). In the following picture, there is no point at the intersection of the three lines corresponding to three equations:
...
![png](../../assets/images/2.9/output_16_0.png)
...
In our two dimensions, the coordinates of $\bs{x}$ are $\begin{bmatrix}
    -1.06451613 \\\\
    3.64516129
...
![png](../../assets/images/2.9/output_22_0.png)
...
<img src="../../assets/images/2.9/dataPoints.png" width=300 heigth=300>
...
Let's start with the creation of the matrix of $\bs{A}$ and $\bs{y}$:
...
![png](../../assets/images/2.9/output_32_0.png)
...
<img src="../../assets/images/2.9/rLinearFit.png" width=400, height=400>
...
<pre class='output'>
[<matplotlib.lines.Line2D at 0x109c87950>]
</pre>



![png](../../assets/images/2.9/output_43_1.png)
