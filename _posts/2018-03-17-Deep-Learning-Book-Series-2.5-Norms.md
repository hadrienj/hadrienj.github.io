...
![png](../../assets/images/2.5/output_9_0.png)
...
![png](../../assets/images/2.5/output_18_0.png)
...
Another advantage of the $L^2$ norm is that its partial derivative is easily computed:
...
We can see this by graphically comparing the squared $L^2$ norm with the $L^2$ norm. The $z$-axis correspond to the norm and the $x$- and $y$-axis correspond to two parameters. The same thing is true with more than 2 dimensions but it would be hard to visualize it.
...
It is the $L^\infty$ norm and correspond to the absolute value of the greatest element of the vector.
...
![png](../../assets/images/2.5/output_32_0.png)
...
- [Wikipedia - Norm](https://en.wikipedia.org/wiki/Norm_(mathematics%29)
